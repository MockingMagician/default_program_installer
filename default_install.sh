...
zenity --info --text="continue to install program like phpstorm, etc... from the toolbox window." --width=200 --height=100 #message pour la suite manuel
